    ...
    def __init__(self):
        ...
        if self.actor is not None:
            ...
            self.camera_sensor_actor = self.world.spawn_actor(
                ...
                carla.Transform(carla.Location(x=0.5, y=-0.0, z=1.3), carla.Rotation(pitch=0.0)),
        ...
        self.image_pub = rospy.Publisher('/spectator_images', Image, queue_size=1)
    ...
    def record_screen(self, tick):
        try:
            ...
            if elapsed_time > 2:
                ...
                img = self.bridge.cv2_to_imgmsg(rgb_data, 'bgr8')
...
if __name__ == '__main__':
    ...
    print('Publishing camera images to spectator_images topic')
    sys.stdout.flush()

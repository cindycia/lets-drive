...
friend class VNode;
	...
	static bool SearchEnd(double timeout, double used_time, Shared_VNode* root);
	static bool TrialEnd(Shared_VNode* cur);
	static bool isPriorValueActive(double move, VNode* vnode);
	static bool isPriorValueActive(double move, QNode* vnode, bool check=true);
	static bool recordUnlabelledbelief(int prior_ID, int depth);
...
protected:
	...
	static void InitPriorLowerBound(VNode* vnode, ScenarioLowerBound* lower_bound,
	...
	static void Expand(QNode* qnode, ScenarioLowerBound* lower_bound,
		...
		RandomStreams& streams, History& history);
	static void FRExpand(QNode* qnode, ScenarioLowerBound* lower_bound,
			ScenarioUpperBound* upper_bound, const DSPOMDP* model,
			RandomStreams& streams, History& history);
	...
	static Shared_QNode* SamplePriorPolicyNode(Shared_VNode* vnode);
	...
	static ValuedAction OptimalActionWithPriors(VNode* vnode);
	...
	static void CalPriorExplorationValue(Shared_QNode* node);
...
public: // lets_drive
	static void ComputePriors(VNode* root, const DSPOMDP * model);
	static void ComputePriorInputsOnly(VNode* root, const DSPOMDP * model);
	static void ComputePriorPref(VNode* cur, const DSPOMDP * model);
	static void ComputeNodePriorInputsOnly(VNode* cur, const DSPOMDP * model);
	...
	static void PriorUpdate(VNode* vnode);
	static void PriorUpdate(QNode* qnode, bool check_bound=true);

public:
	static double state_record_prob;

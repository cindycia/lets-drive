...
void VNode::factored_prior_lower_bound(int idx, double value) {
	switch (idx) {
	case RWD_TOTAL: prior_lower_bound_ = value; break;
	case RWD_NCOL: 	prior_lower_bound_ncol_factor_ = value; break;
	case RWD_COL: 	prior_lower_bound_col_factor_ = value; break;
	default:  throw "Lower bound index over-flow in VNode!";
	}
}

double VNode::factored_prior_lower_bound(int idx) {
	switch (idx) {
	case RWD_TOTAL: return prior_lower_bound_;
	case RWD_NCOL: 	return prior_lower_bound_ncol_factor_;
	case RWD_COL: 	return prior_lower_bound_col_factor_;
	default:  throw "Lower bound index over-flow in VNode!";
	}
}

std::string VNode::text() {
	std::stringstream ss;
	ss << "vnode with edge " << edge_ << ": lb " << lower_bound_ << ", prior lb (" << prior_lower_bound_ << " "
			<< prior_lower_bound_ncol_factor_ <<  " "
			<< prior_lower_bound_col_factor_ <<  ") "
			<< ", ub " << upper_bound_ << std::endl;
	return ss.str();
}
...
void QNode::factored_prior_lower_bound(int idx, double value) {
	switch (idx) {
	case RWD_TOTAL: prior_lower_bound_ = value; break;
	case RWD_NCOL: 	prior_lower_bound_ncol_factor_ = value; break;
	case RWD_COL: 	prior_lower_bound_col_factor_ = value; break;
	default:  throw "Lower bound index over-flow in QNode!";
	}
}

double QNode::factored_prior_lower_bound(int idx) {
	switch (idx) {
	case RWD_TOTAL: return prior_lower_bound_;
	case RWD_NCOL: 	return prior_lower_bound_ncol_factor_;
	case RWD_COL: 	return prior_lower_bound_col_factor_;
...
std::string QNode::text() {
	std::stringstream ss;
	ss << "qnode with edge " << edge_ << ": lb " << lower_bound_ << ", prior lb (" << prior_lower_bound_ << " "
			<< prior_lower_bound_ncol_factor_ <<  " "
			<< prior_lower_bound_col_factor_ <<  ") "
			<< ", ub " << upper_bound_ << std::endl;
	return ss.str();

...
tmux send-keys -t actor_1 'bash repeated_actor.sh lets-drive 1 3000 '$lr Enter

sleep 30
tmux new-window -d -n actor_2
tmux send-keys -t actor_2 'bash repeated_actor.sh lets-drive-labeller 2 4000 '$lr Enter
tmux new-window -d -n actor_3
tmux send-keys -t actor_3 'bash repeated_actor.sh lets-drive-labeller 3 5000 '$lr Enter
...
# sleep 30
# tmux new-window -d -n actor_2 'python3 ../sac_discrete/src/agent/imitation/actor.py --aid 2 --port 4000 --drive_mode lets-drive --env_mode server --lr '$lr 
# tmux new-window -d -n actor_3 'python3 ../sac_discrete/src/agent/imitation/actor.py --aid 3 --port 5000 --drive_mode lets-drive --env_mode server --lr '$lr

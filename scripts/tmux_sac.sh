...
tmux new-window -d -n actor_1 'python3 ../sac_discrete/src/agent/sac_discrete/actor.py --aid 1 --port 3000 --drive_mode imitation_explore --env_mode server --lr '$lr
sleep 30
tmux new-window -d -n actor_2 'python3 ../sac_discrete/src/agent/sac_discrete/actor.py --aid 2 --port 4000 --drive_mode imitation_explore --env_mode server --lr '$lr 
tmux new-window -d -n actor_3 'python3 ../sac_discrete/src/agent/sac_discrete/actor.py --aid 3 --port 5000 --drive_mode imitation_explore --env_mode server --lr '$lr

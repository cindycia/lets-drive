...
const double POS_RLN = 1.5; // position resolution
const double VEL_RLN = 1.0; // velocity resolution

const double CONTROL_FREQ = 3;
const double ACC_SPEED = 3.0;
const double NUM_ACC = 3;
const double NUM_VEL_BINS = 8;

const double NumLaneDecisions=3;
...
const double IMAGE_HALF_SIZE_METER = 20.0;
